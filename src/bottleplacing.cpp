...
//         // First open the gripper
            ...
            gripper.grasp(0.01, 0.02, 70);
              double time_g = 0.0;
              std::array<double, 16> initial_pos_grasp;
              auto grasping = [&initial_pos_grasp, &time_g,&client_socket](const franka::RobotState& rstate, franka::Duration periode) -> franka::CartesianPose
        {
                time_g += periode.toSec();

                initial_pos_grasp = rstate.O_T_EE_c;
                
            


               std::array<double, 16> current_pos = initial_pos_grasp;
//             
               franka::CartesianPose output = current_pos;
              ...
              if(time_g>= 2.0)
                ...
                //std::cout << "t:" << time_g << "  periode: " << periode.toSec() << " z-Koord.: " << rstate.O_T_EE_c[14] << std::endl;
...
//             current_pos[13] += dy;
 ...
 //         4. Move around
             std::cout << "4. Move around"   << client_socket << std::endl;
           double time_3 = 0.0;
...
//    //4. 2 + Move around
             std::cout << "4.2 Move around"  << client_socket << std::endl;
           double time_32 = 0.0;
...
//    //4. 3 + Move around
             std::cout << "4.3 Move around"   << client_socket << std::endl;
           double time_33 = 0.0;
...
//         // 5: place object
         std::cout << "5. Place the bottle"   << client_socket << std::endl;
           double time_4 = 0.0;
...
//         // 7. Move up
         std::cout << "7. Move up"   << client_socket  << std::endl;
         double time_6= 0.0;
