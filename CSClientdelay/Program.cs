    ...
    class Program
    {
        ...
        static void process_and_upload_fci_data()
        {
            ...
            void breakReadLoop(Object source, ElapsedEventArgs e){
                ...
                {
                    writer.WriteLine("ts_in,ts_out,delay,"+string.Join(",",updateTwinIds));   
            ...
            void readData(Object source, ElapsedEventArgs e)
            {
                ...
                {   
                    ...
                    TimeSpan delay = DateTime.Parse(ts_uploaded) - DateTime.Parse(ts_received);
                    // Addon: received valid data gets saved in list
                    m_dataValidIn.Add(ts_received + "," + ts_uploaded + "," + delay.TotalMilliseconds + "," +fci_data_ascii.Substring(indexOpen+7, indexClosed-8));
